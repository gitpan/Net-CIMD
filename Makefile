# This Makefile is for the Net::CIMD extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Net/CIMD.pm]
#     AUTHOR => q[Zarhri Badr <badr.zarhri@gmail.com>]
#     NAME => q[Net::CIMD]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Net/CIMD.pm]
...
TO_INST_PM = lib/Net/CIMD.pm

PM_TO_BLIB = lib/Net/CIMD.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Net/CIMD.pm $(INST_MAN3DIR)/Net::CIMD.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         Net-CIMD' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Net/CIMD.pm' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>pure Perl implementation of CIMD2 over TCP</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Zarhri Badr &lt;badr.zarhri@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/Net/CIMD.pm blib/lib/Net/CIMD.pm 
